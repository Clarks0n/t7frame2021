...
import { AKUMAMT, ALISAMT, ANNAMT,ARMORKINGMT,ASUKAMT,BOBMT,BRYANMT,CLAUDIOMT,DEVILJINMT,DRAGUNOVMT,EDDYMT,ELIZAMT,FAHKUMRAMMT,FENGMT,GANRYUMT,
        ...
        LEEMT,LEIMT,LEOMT,LEROYMT,LIDIAMT,LILIMT,LUCKYMT,MARDUKMT,MASTERRAVENMT,MIGUELMT,NEGANMT,NINAMT,NOCTISMT,PAULMT,SHAHEENMT,STEVEMT, XIAOYUMT ,YOSHIMITSUMT ,ZAFINAMT 
    } from './dataMeta';
...
export const charData = charName.map((item,i) => {
    return (
        {title: item, dataFrame: charFrame[i], dataMeta: charMeta[i], id: RandomHexString(8)}
    ) 
});
